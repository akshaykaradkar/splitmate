...
export interface DividerProps
  extends React.ComponentProps<typeof DividerWebComponent> {
...
export function Divider({
  ...
  style = {
    paddingInlineEnd: !isVertical && (inset || insetEnd) ? '16px' : undefined,
    paddingInlineStart:
      !isVertical && (inset || insetStart) ? '16px' : undefined,
    paddingBlockEnd: isVertical && (inset || insetEnd) ? '16px' : undefined,
    paddingBlockStart: isVertical && (inset || insetStart) ? '16px' : undefined,
    ...style,
  };
