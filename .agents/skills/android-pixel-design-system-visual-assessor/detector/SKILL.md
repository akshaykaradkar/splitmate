...
# UI Detector (Android Pixel Design System)
...
extraction; whether a component is APDS adherent is not relevant for this
skill. It serves as the foundational detection step for any Android Pixel Design System audit.
...
3.  **APDS Adherence Independence:** Remember that the sole objective of
    this skill is identifying components. Whether a component is APDS
...
1.  **Palette:** Use the `color` skill ([SKILL.md](../../../../../skills/color/SKILL.md)) to
    extract the page-level color scheme from the screenshot:
    ...
    object, referencing APDS colors.

2.  **Type Scale:** The list of font families and weights used (e.g. "Google Sans-Regular", "Google Sans Text-Medium", "Roboto-Medium").
...
structural sub-element of a larger container. In APDS audits, every
