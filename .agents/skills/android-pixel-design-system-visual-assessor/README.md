# Android Pixel Design System Visual Assessor Skill

This directory contains the AI agent skill instructions (`SKILL.md`), rubrics,
and reference guidelines for the **Android Pixel Design System (APDS) Visual Assessor**—an agent
capability that audits screenshots and user interfaces for compliance with
Android Pixel Design System (APDS) guidelines.

--------------------------------------------------------------------------------

## 1. Official Skill Evaluation (Everest & Plx Dashboard)

Authoritative, end-to-end evaluation and regression scoring of the APDS
...
*   **Golden Evals Dashboard:** You can monitor official compliance scores,
    ...
    on the
    **[UX APDS UI Assessor Golden Evals Plx Dashboard](https://dashboards.corp.google.com/view/ux_apds_ui_assessor_eval_goldens)**.
...
*   **Evaluation Framework Overview:** See
    **AI Evals for APDS Visual Assessor**
...
*   **Running a Gut Check:**
    ...
    ```bash
    evalin run ux/gdp/ai/skills/android_pixel_design_system_visual_assessor/sample_evals/EVAL.txtpb --skills=ux/gdp/ai/skills/android_pixel_design_system_visual_assessor
    ```
...
*   **`references/`:** Specialized APDS component rubrics, guidelines, and
