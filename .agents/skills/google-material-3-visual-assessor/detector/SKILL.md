...
extraction; whether a component is Material adherent is not relevant for this
skill. It serves as the foundational detection step for any Google Material 3 Design
System audit.
...
3.  **Material Adherence Independence:** Remember that the sole objective of
    this skill is identifying components. Whether a component is Material
...
2.  **Type Scale:** The list of font families and weights used (e.g. "Google
    Sans-Regular", "Roboto-Medium").
...
structural sub-element of a larger container. In Google Material 3 audits, every
