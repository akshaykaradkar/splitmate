# Elements GM3 Visual Assessor Skill

This directory contains the AI agent skill instructions (`SKILL.md`), rubrics,
and reference guidelines for the **Elements GM3 Visual Assessor**—an agent
capability that audits screenshots and user interfaces for compliance with
the Elements GM3 Design System guidelines.

--------------------------------------------------------------------------------

## 1. Official Skill Evaluation (Everest & Plx Dashboard)

Authoritative, end-to-end evaluation and regression scoring of the Elements GM3
...
*   **Golden Evals Dashboard:** You can monitor official compliance scores,
    ...
    on the
    **[UX Elements GM3 UI Assessor Golden Evals Plx Dashboard](https://dashboards.corp.google.com/view/ux_elements3_ui_assessor_eval_goldens)**.
...
*   **Evaluation Framework Overview:** See
    **AI Evals for Elements GM3 Visual Assessor**
...
*   **Running a Gut Check:**
    ...
    ```bash
    evalin run ux/gdp/ai/design_systems/elements-3/skills/visual-assessor/sample_evals/EVAL.txtpb --skills=ux/gdp/ai/design_systems/elements-3/skills/visual-assessor
    ```
...
*   **`references/`:** Specialized Elements GM3 component rubrics, guidelines, and
    scoring rules referenced on demand by the agent during Phase 2 component
    evaluation.
*   **`detector/`:** Sub-skill (`elements-3-visual-detector`) responsible for Phase 1 UI
